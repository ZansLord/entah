...
console.log(color(figlet.textSync('ElainaMd', {
		font: 'Pagga',
...
console.log(color('\nHello, I am ZansLord, the main Developer of this bot.\n\nThanks for using: Elaina Bot','aqua'))
console.log(color('\nYou can follow me on Instagram: abdulmalik_4342','aqua'))

    let { version, isLatest } = await fetchLatestBaileysVersion()
    const Deepak = DeepakConnect({
        logger: pino({ level: 'silent' }),
        printQRInTerminal: true,
        browser: ['Elaina by: ZansLord','Safari','1.0.0'],
        auth: state,
        version
    })
...
Deepak.ev.on('groups.update', async pea => {
       ...
       ppgc = 'https://i.ibb.co/ZSj6pDM/cheemspic.jpg'
       }
        ...
        try {
            ...
            for (let num of participants) {
                ...
                try {
                    ...
                    ppuser = 'https://i.ibb.co/ZSj6pDM/cheemspic.jpg'
                }

                try {
                    ppgroup = await Deepak.profilePictureUrl(anu.id, 'image')
                } catch {
                    ppgroup = 'https://i.ibb.co/ZSj6pDM/cheemspic.jpg'
                }
...
I am *ElainaBot*, Welcome to ${metadata.subject}.
