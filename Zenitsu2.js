...
switch(command) {
    ...
    let { data } = await axios.get('https://api.github.com/repos/ZansLord/elaina');
    teks = `*ZansLord Script*\n\n*GitHub*: https://github.com/robiazel4/Elaina-MultiDevice\n\nDont forget to follow me on *GitHub* and give a ⭐️ to my projects. `
    let buttons = [
    ...
    mediaType:1,
    mediaUrl: 'https://i.ibb.co/ZSj6pDM/cheemspic.jpg',
    sourceUrl: "https://i.ibb.co/ZSj6pDM/cheemspic.jpg"
    }}*/
...
case 'me': case 'profile': case 'p':
  ...
  if (!isInventoriBuruan){ addInventoriBuruan(m.sender) }
     ...
     try {
      ...
      pfp ='https://i.ibb.co/ZSj6pDM/cheemspic.jpg'
    }
...
case 'support': case 'supportgc':
    ...
    reply(`*My support group:* https://chat.whatsapp.com/LJsK2qecGOeKCfc97giQFB`)
    break
...
Elaina Bot With You Forever!! 🐶🤚


ꪶ🐕 Elaina-Bot Info 🐕ꫂ
➙Owner : Abdul Masuk Surga☁️
➙User :  ${pushname}
➙Prefix : [ ${prefix} ]
➙Mode : Public
➙Platform : Linux
...
case 'lava': case 'rockart': case 'bloodglas': case 'halloween': case 'darkgold': case 'joker': case 'wicker':
 case 'firework': case 'skeleton': case 'blackpinkart': case 'sand': case 'glue': case '1917': case 'leaves': case 'demon': {
             ...
             let anutexpro = await maker.textpro(link, q)
                Deepak.sendMessage(m.chat, { image: { url: anutexpro }, caption: `Made by ElainaBot` }, { quoted: m })
             }
             break
case'glitch3':
...
maker.textpro("https://textpro.me/create-glitch-text-effect-style-tik-tok-983.html", [
    `${teks1}`,`${teks2}`])
  .then((data) => Deepak.sendMessage(m.chat, { image: { url: data }, caption: `Made by ElainaBot` }, { quoted: m }))
...
case '':
    ...
    if (isBanChat) return reply(mess.bangc)
      ...
      Deepakpic ='https://i.ibb.co/ZSj6pDM/cheemspic.jpg'
